...
if not os.path.exists(MODEL_FILE_PATH):
    print("Modelo 'naive_bayes_classifier.pkl' não encontrado.")
    print("Execute antes o script 'naive_bayes_classifier' para gerar e treinar o modelo.")
    sys.exit(1)
...
def predict_favorite_recipes_naive_bayes(user_liked_ingredients):
    if model is None or label_encoder is None: 
        raise ValueError("Um ou mais componentes do modelo (Naive Bayes, LabelEncoder) não foram carregados. Verifique o caminho do arquivo do modelo.")
